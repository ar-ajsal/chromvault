...
(function () {
  function resolveApiBase() {
    if (typeof window !== 'undefined' && window.__CHROMVAULT_API_BASE__) {
      return String(window.__CHROMVAULT_API_BASE__).replace(/\/+$/, '');
    }
